...
public class HelloController {
    ...
    public void dataOfTwo(int[][] buttonClicksNew, int count, List<Pair<Integer, Integer>> buttonListREDTwo, List<Pair<Integer, Integer>> buttonListBLKTwo)
    {
        buttonClickssend=buttonClicksNew;
        clickCountSend=count;
        buttonListREDsend=buttonListREDTwo;
        buttonListBLACKsend=buttonListBLKTwo;
    }
    ...
    public void handleButtonClick(ActionEvent event) throws IOException {
        clickCount++;
        System.out.println("click count at start: "+clickCount);
            ...
            //butt.setDisable(false);
                if (buttonClicks[row][col]==0) {
                    ...
                    if (buttonListRED.size() == MAX_CLICKS) {
                        ...
                        winner.setStyle("-fx-background-color: white;");
    ...
    public void switchPlayer2(ActionEvent event) throws IOException {
        FXMLLoader loader= new FXMLLoader(getClass().getResource("player2.fxml"));
        root=loader.load();
        Player2controller cc=loader.getController();
        cc.dataOfOne(buttonClicks, clickCount, buttonListRED, buttonListBLACK);
        cc.dataOfTwo(buttonClickssend, clickCountSend, buttonListREDsend, buttonListBLACKsend);
